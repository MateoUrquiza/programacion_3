  ...
  return (
    ...
    >
      <body className="min-h-screen flex flex-col">
        ...
        <footer className="bg-gray-800 text-white flex justify-between px-4 py-4">
          <h1 className="text-xs">Todos los derechos reservados</h1>
          <h1 className="text-sm font semibold">Terminos y Condiciones</h1>
        </footer>
